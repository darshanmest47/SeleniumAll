...
//		 options.addArguments("--headless=new");
	...
	@Test(description="Explicit wait and navigating backwards and refreshing page once",priority = 9,dependsOnGroups ="window switching" )
	...
	@Test(description="Taking screenshot in selenium and copying to folder",priority = 10)
